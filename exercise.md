...
set ylabel "温度"
plot "weather2025.csv" using 1:2:xtic(10) title "最高気温" w l, "weather2025.csv" using 1:3:xtic(10) title "最高気温(平年)" w l,"weather2025.csv" using 1:4:xtic(10) title "最低気温" w l,"weather2025.csv" using 1:5:xtic(10) title "最低気温(平年)" w l
